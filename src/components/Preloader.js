...
export default function Preloader({ loading, onFinish }) {
    ...
    return (
        <div ref={preloaderRef} className="fixed inset-0 z-[9999] flex items-center justify-center bg-white dark:bg-black pt-9 max-lg:pt-10 max-md:pt-8 pointer-events-none flex-col min-h-screen text-center px-6">
            {/* Badge */}
            ...
            {/* Headline */}
            <h1 className="text-5xl pointer-events-none sm:text-6xl md:text-7xl lg:text-[5.5rem] font-rational font-extrabold tracking-tight leading-[1.05] text-neutral-900 dark:text-white max-w-3xl mb-5 text-center">
                <TextType
