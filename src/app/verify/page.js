...
export default function VerifyPage() {
  ...
  return (
    <main className="min-h-screen relative flex items-center justify-center px-6 bg-white dark:bg-siteblack overflow-hidden">
      ...
      <div className="grid md:grid-cols-2 gap-10 w-full max-w-5xl">
        ...
        <motion.div
          ...
          className="p-8 rounded-3xl border border-neutral-200 dark:border-neutral-800 bg-white/60 dark:bg-neutral-900/40 backdrop-blur"
        >
          ...
          <input
            ...
            className="w-full mt-2 mb-6 px-4 py-3 rounded-xl border border-neutral-300 dark:border-neutral-700 bg-transparent focus:outline-none focus:ring-2 focus:ring-[00ff40] uppercase"
          />
        ...
        <motion.div
          initial={{ opacity: 0, x: 30 }}
          animate={{ opacity: 1, x: 0 }}
          className="p-8 rounded-3xl border border-neutral-200 dark:border-neutral-800 bg-white/60 dark:bg-neutral-900/40 backdrop-blur flex flex-col justify-center"
        >
          {!result ? (
